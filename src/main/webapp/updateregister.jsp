        ...
        <form action="update" method="post">
            ...
            <div class="content">
                 <div class="input-box">
                    ...
                    <input type="text" placeholder="" name="id" value="<%= id %>" >
                </div>
                <div class="input-box">
                    <label for="name">First Name</label>
                    <input type="text" placeholder="" name="fname" value="<%= fname %>" >
                </div>
                <div class="input-box">
                    <label for="Address">Last Name</label>
                    <input type="text" placeholder="Enter the last name" name="lname" value="<%= lname %>" >
                </div>
                <div class="input-box">
                ...
                <div class="input-box" >
                    ...
                    <input type="text" placeholder="Enter your Phone Number" id="pnum" name="pnum" value="<%= phonenumber %>">
                </div>
                
                <div class="input-box">
                    <label for="Password">Password</label>
                    <input type="text" placeholder="Enter the Password" id="password" name="pwd"  value="<%= password %>">
