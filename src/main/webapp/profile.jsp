<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>More</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="orderplacement.jsp" class="active">Place Order</a></li>
    ...
    <section class="Order-place">
         ...
         %>		
                        ...
                        <form action="OrderUpdate" method="post" class="placement-form">
                            <div class="col-12">
                             <div class="row mt-3 mx-4">
                                   <div class="col-12">
                                    <label class="order-form-label">Order Id</label>
                                    <input type="text" name="fullname" value ="<%= oid %>" class="form-control">
                                   </div> 
                                </div>
                                <div class="row mt-3 mx-4">
                                   <div class="col-12">
                                    <label class="order-form-label">Full Name</label>
                                    <input type="text" name="fullname" value ="<%= fname %>" class="form-control">
                                   </div> 
                                </div>

                                <div class="row mt-3 mx-4">
                                   <div class="col-12">
                                    <label class="order-form-label">Mobile Number</label>
                                    <input type="text" name="phone" value ="<%= phonenumber %>" class="form-control">
                                   </div> 
                                </div>
                                <div class="row mt-3 mx-4">
                                    ...
                                    <div data-mdb-input-init class="form-outline datepicker"
                                        ...
                                        <input type="date" class="form-control" name="orderdate" value ="<%= date %>"
                               ...
                               <input type="submit" data-mdb-button-init id="btnSubmit" data-mdb-ripple-init
